...
//   reagent_name: text (nullable)
//   cost_per_test: numeric (nullable)
//   avg_ticket_price: numeric (nullable)
// Table: leads
//   id: uuid (not null, default: gen_random_uuid())
//   name: text (not null)
//   phone: text (not null)
...
//   reagent_type: text (nullable)
//   equipment_model: text (nullable)
//   volume: text (not null)
//   created_at: timestamp with time zone (not null, default: now())
//   recommended_item: text (nullable)
// Table: partners
//   id: uuid (not null, default: gen_random_uuid())
//   name: text (not null)
...
//     USING: true
// Table: leads
//   Policy "auth_all_leads" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "public_insert_leads" (INSERT, PERMISSIVE) roles={public}
//     WITH CHECK: true
// Table: partners
//   Policy "auth_all_partners" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "public_select_partners" (SELECT, PERMISSIVE) roles={public}
//     USING: true
// Table: showcase_items
